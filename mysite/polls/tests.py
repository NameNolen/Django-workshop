...
class QuestionMethodTests(TestCase):
	def test_was_published_recently_with_future_question(self):
		"""
		was_published_recently() shold return False for question 
...
def create_question(question_text,days):
	"""
	Creates a question with the given question_text published given number of days offset to now 
...
class QuestionViewTests(TestCase):
	...
	def test_index_view_with_a_future_question(self):
		"""
		Questionwith a pub_date in the future should not be dispoayed on the index page.
		"""
...
class QuestionIndexDetailTests(TestCase):
	...
	def test_detail_view_with_a_past_question(self):
		"""
		The detail view of a question with a pub_date in the past should display the question'text.
		"""
